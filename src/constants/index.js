...
export const columns = {
    MERCHANT: ['id', 'role_id', 'user_id', 'first_name', 'last_name', 'code', 'min_payin', 'max_payin', 'payin_commission', 'min_payout', 'max_payout', 'payout_commission', 'is_test_mode', 'is_enable', 'dispute_enable', 'is_demo', 'balabce', 'company_id', 'config', 'created_by', 'updated_by', 'created_at', 'updated_at', 'is_obsolete'],
