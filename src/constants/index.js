...
export const columns = {
    ...
    RESET_DATA_HISTORY: ['id', 'sno', 'payin_id', 'pre_status', 'created_by',  'updated_by', 'created_at', 'updated_at', 'company_id', 'config'],
    BANK_RESPONSE: ['id', 'sno','status', 'bank_id', 'amount', 'upi_short_code', 'utr', 'is_used', 'created_at', 'updated_at', 'created_by', 'company_id', 'config' , 'updated_by']
