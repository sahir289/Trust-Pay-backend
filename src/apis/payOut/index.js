...
import { createPayout, deletePayout, getByIdPayouts, getPayouts, updatePayout } from './payOutController.js';
 ...
 *                     example: "active"
 */
router.get('/getAll', tryCatchHandler(getPayouts));
router.get('/:id',  tryCatchHandler(getByIdPayouts));
