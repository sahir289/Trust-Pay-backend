...
export const getPayInwithMerchantDao = async (filters) => {
  try {
    const sql = `SELECT p.merchant_order_id, m.config->'unblocked_countries' AS unblockedcountries, p.merchant_id, c.config->'blocked_users' AS blocked_users ,p.user as userId
