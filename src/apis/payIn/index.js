...
import { assignedBankToPayInUrl, checkPayInStatus, generatePayInUrl, getPayinsByUtrController, payInIntentGenerateOrder, resetDeposit, updateDepositStatus, updatePaymentNotificationStatus, validatePayInUrl } from './payInController.js';
...
router.get('/payin-data',  tryCatchHandler(getPayinsByUtrController));
