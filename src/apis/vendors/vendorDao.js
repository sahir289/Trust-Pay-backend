...
export const getVendorsDao = async (
    ...
    try {
        const baseQuery = `SELECT id, first_name,user_id, last_name, code, payin_commission, payout_commission, balance, created_by, updated_by, config, created_at, updated_at FROM "${tableName.VENDOR}" WHERE 1=1`;
