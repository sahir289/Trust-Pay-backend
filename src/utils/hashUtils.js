...
export const createHash = (data) => {
  ...
  console.log(`Input Data: ${data}, Generated Hash: ${hash}`); // Debugging log
  return hash;
};

export const compareHash = (data, hash) => {
  const generatedHash = createHash(data);
  console.log(`Comparing Hashes -> Input Data: ${data}, Generated Hash: ${generatedHash}, Provided Hash: ${hash}`); // Debugging log
